...
namespace DemonDoor
{
    public partial class _
    {
        ...
        {
            pixel = new Texture2D(Game1.game.GraphicsDevice, 1, 1);
        ...
        public static Texture2D MakeBox(int w, int h, Color[] boxcolors)
        {
            ...
            RenderTarget2D dest = new RenderTarget2D(Game1.game.GraphicsDevice, w, h, true, SurfaceFormat.Color, DepthFormat.Depth24);

            sb = new SpriteBatch(Game1.game.GraphicsDevice);
            Game1.game.GraphicsDevice.SetRenderTarget(dest);
            Game1.game.GraphicsDevice.Clear(ClearOptions.Target, Color.Transparent, 0, 0);
            sb.Begin();
